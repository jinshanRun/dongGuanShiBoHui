<template>
    <div class="webexh">
      <div class="webexh-banner" v-loading="loading"><img src="../../assets/img/yunsbck3.png" alt=""></div>
     <div class="webexhtxt">
...
export default {
  ...
  data() {
    return {
      ...
      companyList: null,
      hotCompanyList: null,
      uuid: this.$route.query.uuid !==undefined ? this.$route.query.uuid : 'f1327fceaa2440f796570fb48856407220201023173039',
      page: 0,
      size:5,
      // 总数
      countTotal: 0,
