<template>
    <div class="webexh">
      <div class="webexh-banner" v-loading="loading"><img src="../../assets/img/webexbck2.png" alt=""></div>
     <div class="webexhtxt">
...
export default {
  ...
  data() {
    return {
      ...
      companyList: null,
      hotCompanyList: null,
      uuid: this.$route.query.uuid !==undefined ? this.$route.query.uuid : '5f29577d3fd249d1b59d4b9cc2d8ba3920201023172717',
      page: 0,
      size: 5,
      // 总数
      countTotal: 0,
