<template>
  <div class="webexh">
    <div class="webexh-banner" v-loading="loading">
      <img src="../../assets/img/yunsbck4.png" alt="" />
    </div>
    <div class="webexhtxt">
...
export default {
    ...
    return {
      ...
      uuid:
        this.$route.query.uuid !== undefined
          ...
          : "d6ccd8b213b2419fbd53fe4e5070ea4420201023173027",
      page: 0,
      size: 5,
      // 总数
      countTotal: 0,
  ...
  methods: {
    ...
    hotcompanyList(uuid) {
      this.$http
        .get("/exhibitioncompanyapi/hotCompanyList/" + uuid)
        .then((res) => {
