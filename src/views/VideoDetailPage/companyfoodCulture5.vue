<template>
    <div class="webexh">
      <div class="webexh-banner" v-loading="loading"><img src="../../assets/img/webexbck5.png" alt=""></div>
     <div class="webexhtxt">
...
export default {
  ...
  data() {
    return {
      ...
      companyList: null,
      hotCompanyList: null,
      uuid: this.$route.query.uuid !==undefined ? this.$route.query.uuid : '2b944fcfa09e42d588dcb6b5ace83ea420201023172900',
      page: 0,
      size: 5,
      // 总数
      countTotal: 0,
