<template>
    <div class="webexh">
      <div class="webexh-banner" v-loading="loading"><img src="../../assets/img/webexbck4.png" alt=""></div>
     <div class="webexhtxt">
...
export default {
  ...
  data() {
    return {
      ...
      companyList: null,
      hotCompanyList: null,
      uuid: this.$route.query.uuid !==undefined ? this.$route.query.uuid : 'ee51986b1c97468eb20f28a1fc17826f20201023172841',
      page: 0,
      size: 5,
      // 总数
      countTotal: 0,
