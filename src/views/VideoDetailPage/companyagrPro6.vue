<template>
    <div class="webexh">
      <div class="webexh-banner" v-loading="loading"><img src="../../assets/img/webexbck6.png" alt=""></div>
     <div class="webexhtxt">
...
export default {
  ...
  data() {
    return {
      ...
      companyList: null,
      hotCompanyList: null,
      uuid: this.$route.query.uuid !==undefined ? this.$route.query.uuid : '324e4b21bb1b4647bc0a7d1a1ad6655820201023172934',
      page: 0,
      size: 5,
      // 总数
      countTotal: 0,
