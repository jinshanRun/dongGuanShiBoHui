<template>
    ...
    <p><img src="../assets/img/lication.png" alt="">当前位置：<a href="/">首页</a>>展商服务><span>参展商招商手册</span></p>
          <div class="expo-content-left">
              <ul class="expo-content-list">
                 <li><router-link :to="{name:'exhibitionHall1'}">展厅类别</router-link></li>
                  ...
                  <li><a href="http://39.106.51.133:8082/dongguan/att2.pdf" target="_blank" style="width:184px;height:40px;display:block">招商手册</a></li>
